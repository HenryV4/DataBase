...
CREATE TABLE IF NOT EXISTS client (
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (discount_cards_id) REFERENCES discount_cards(id) ON DELETE SET NULL
) ENGINE = InnoDB;
...
INSERT INTO room (room_type, price_per_night, available, hotel_id) VALUES
('Single', 50, 1, 1),
('Double', 80, 1, 1),
('Suite', 150, 1, 2),
('Deluxe', 200, 1, 3),
...
INSERT INTO discount_cards (name, discount) VALUES
('silver', '5%'),
('gold', '10%'),
('platinum', '15%'),
('diamond', '20%');
...
INSERT INTO client (full_name, email, phone_num, discount_cards_id) VALUES
...
INSERT INTO payment (card_number, payment_amount, payment_date, status, client_id) VALUES
('1234567890123456', 250, '2024-09-10', 1, 1),
('2345678901234567', 400, '2024-09-11', 1, 2),
('3456789012345678', 600, '2024-09-12', 0, 3),
('4567890123456789', 1000, '2024-09-13', 1, 4),
('5678901234567890', 275, '2024-09-14', 1, 5),
('6789012345678901', 450, '2024-09-15', 1, 6),
('7890123456789012', 500, '2024-09-16', 1, 7),
('8901234567890123', 550, '2024-09-17', 0, 8),
('9012345678901234', 320, '2024-09-18', 1, 9),
('0123456789012345', 600, '2024-09-19', 1, 10);

-- Insert data for booking
INSERT INTO booking (check_in_date, check_out_date, total_price, room_id, client_id, payment_id) VALUES
...
INSERT INTO review (rating, comment, client_id, hotel_id) VALUES
...
INSERT INTO hotel_has_amenities (hotel_id, amenities_id) VALUES
(1, 1), (1, 2), (1, 3), 
(2, 1), (2, 4), 
(3, 1), (3, 5), 
(4, 6), 
...
-- Index for hotel by location and stars
CREATE INDEX idx_hotel_location_stars ON hotel(location_id, stars);

-- Index for client by email and phone number
CREATE INDEX idx_client_email_phone ON client(email, phone_num);

-- Index for room by price per night and availability
CREATE INDEX idx_room_price_available ON room(price_per_night, available);

-- Index for booking by check-in date
